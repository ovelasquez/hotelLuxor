...
function advanced_booking_calendar_show_analytics() {
	...
	if($foreachcount == 0){ // Check if there are calendars
		...
		$localizedVars['availabilityLabels'] = json_encode($availabilityLabels, JSON_NUMERIC_CHECK);
		$localizedVars['availabilityData'] = json_encode($availabilityData, JSON_NUMERIC_CHECK);	
		$localizedVars['totalAvailData'] = json_encode($totalAvailData, JSON_NUMERIC_CHECK);
		$output .= '
		...
		$localizedVars['dateGraphData'] = json_encode($dateData, JSON_NUMERIC_CHECK);
		$localizedVars['dateGraphTicks'] = json_encode($dateTicksArray, JSON_NUMERIC_CHECK);
		...
		$localizedVars['personPieLabels'] = json_encode($personPieLabels, JSON_NUMERIC_CHECK);
		$localizedVars['personPieData'] = json_encode($personPieData, JSON_NUMERIC_CHECK);
		$localizedVars['personCountSum'] = json_encode($personCountSum, JSON_NUMERIC_CHECK);	
		...
		$localizedVars['revenueLabels'] = json_encode($revenueLabels, JSON_NUMERIC_CHECK);
		$localizedVars['revenueData'] = json_encode($revenueData, JSON_NUMERIC_CHECK);
		$output .= '
			<div class="uk-width-1-1 uk-width-medium-1-2">
				<div class="abc-analytics-wrapper ">
