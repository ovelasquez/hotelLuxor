...
function abc_booking_addExtra() {
	...
	if ( isset($_POST["name"]) && isset($_POST["mandatory"]) && isset($_POST["calculation"]) && isset($_POST["price"])) {
...
function abc_booking_editExtra() {
	...
	if ( isset($_POST["id"]) && isset($_POST["name"]) && isset($_POST["mandatory"]) && isset($_POST["calculation"]) && isset($_POST["price"])) {
		$name = sanitize_text_field($_POST["name"]);
		$explanation = sanitize_text_field($_POST["explanation"]);
		$calculation = sanitize_text_field($_POST["calculation"]);
		$mandatory = sanitize_text_field($_POST["mandatory"]);
		...
		$output .= ' <h3>'.__('Existing Extras', 'advanced-booking-calendar').'</h3>
					  ...
					  <div class="wrap">
						...
						<table class="form-table">
						  ...
						  <tr>
							<td><label for="explanation">'.__('Explanation', 'advanced-booking-calendar').'</br><em>'.__('(optional)', 'advanced-booking-calendar').'</em></label></td>
							<td align="left"><input placeholder="Get Wifi-access in your room." name="explanation" id="explanation" type="text" class="regular-text code"/>
												 <p class="description">'.__('Explain what the extra is for.', 'advanced-booking-calendar').'</p></td>
						  </tr>
						  <tr>
							<td><label for="calculation">'.__('Type of calculation', 'advanced-booking-calendar').'</label></td>
