...
function abc_booking_showCalOverview ( $atts ) {
	...
	$calOverviewResult = '<!-- Begin Advanced Booking Calendar WordPress plugin: https://www.booking-calendar-plugin.com -->';
	$legend = '';
	...
	if(getAbcSetting('poweredby') == 1){
		$calOverviewResult .= '<div class="abc-powered-by">
				'.__('Powered by:', 'advanced-booking-calender').'&nbsp;<a href="https://booking-calendar-plugin.com" target="_blank">
				Advanced Booking Calendar</a>
			</div>';
	}
