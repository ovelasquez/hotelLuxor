 ...
 * @since 1.0.0
 */
class Travel_Eye_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'travel_eye';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			...
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'travel-eye' ), $i ),
	...
	function add_footer_widgets() {
		...
		$args = array(
		'container' => 'div',
		'before'    => '<div class="container"><div class="main-wrapper"><div class="inner-wrapper">',
		'after'     => '</div><!-- .inner-wrapper --></div><!-- .main-wrapper --></div><!-- .container -->',
		);
...
// Initialize.
$travel_eye_footer_widgets = new Travel_Eye_Footer_Widgets();
