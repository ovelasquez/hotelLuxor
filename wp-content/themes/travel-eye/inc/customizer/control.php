 ...
 */
class Travel_Eye_Heading_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Travel_Eye_Message_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Travel_Eye_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Travel_Eye_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Travel_Eye_Dropdown_Sidebars_Control extends WP_Customize_Control {
